...
const plans = [
  {
    ...
    features: ["30 credits", "(≈) 10 lượt xuất file", "Hỗ trợ qua email"],
    popular: false,
  },
  {
    name: "Gói A2",
    ...
    features: ["60 credits", "(≈) 20 lượt xuất file", "Hỗ trợ ưu tiên"],
    popular: true,
  },
  {
    name: "Gói A3",
    price: 150000,
    description: "Gói lớn cho người dùng có nhu cầu cao.",
    features: ["200 credits", "(≈) 70 lượt xuất file", "Hỗ trợ ưu tiên"],
    popular: false,
  },
  {
    name: "Doanh nghiệp",
